agent_list = [
    {
        "name": "Alice",
        "persona": "Friendly and curious, likes to ask questions to clarify concepts.",
        "position": "Middle school student"
    },
    {
        "name": "Bob",
        "persona": "Methodical and detail-oriented, prefers to double-check every step.",
        "position": "Middle school student"
    },
    {
        "name": "Charlie",
        "persona": "Quick and confident, enjoys proposing answers but may overlook details.",
        "position": "Middle school student"
    }
]
